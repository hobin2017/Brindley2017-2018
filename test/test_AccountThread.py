...
class MyThread4(QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.url = 'http://api.commaai.xin/v1/face/find_user'
        ...
        self.dict01 = {"api_sign":None,
          ...
          'store_id': '1',
          'client_time':None}
        self.dict02 = {}  # the dictionary object of the HTTP get result
    ...
    def run(self):
        ...
        if len(faces) ==1:
            ...
            # print(self.dict01)
            resp01 = requests.post(self.url, files=self.files, data=self.dict01)
            # the detection might fail.
            if resp01.status_code == 200:
                self.dict02 = json.loads(resp01.text)
                print(self.dict02['data'])
                resp02 = requests.get(self.dict02['data']['avatar_url'])
