...
from AccountThread import MyThread4
...
class PaymentSystem(QMainWindow):
    ...
    def __init__(self):
        ...
        self.thread5 = MyThread4(parent=self)
    ...
    def work5(self, result_sql):
        ...
        self.thread6.start()
        # QTimer in here or Account thread??
        self.thread5.frame = self.main_widget.mainlayout.rightlayout.secondlayout.thread1.frame
        self.thread5.start()
        self.thread3.start()
        print('work5 ends')
