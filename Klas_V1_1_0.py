...
"""
Payment System
Compared with the version 1.0.0, this version modifies the cooperation between account thread and the ml gesture model;
In other words, the account thread uses the frame provided by the ml gesture model;
Another difference is that self.wave_status is added to weigher module (Weigher2_1);
author: hobin;
...
from AccountThread import MyThread4_0_1
...
from Weigher import Weigher1_1, Weigher2_1
...
class PaymentSystem_klas(QObject):
    ...
    def __init__(self, **kwargs):
        ...
        self.weigher2 = Weigher2_1(**self.myconfig.data['weigher'])
        ...
        self.thread5 = MyThread4_0_1(parent=self, **self.myconfig.data['account'])
        ...
        self.thread5.failed_detection_local.connect(self.account_work7_klas)
        self.thread5.failed_detection_multiple.connect(self.account_work7_klas)
        ...
        self.thread0_0.upload_image.connect(self.ml_gesture_work10_klas02)
    ...
    def ml_gesture_work10_klas02(self, gesture_img, datetime):
        """
        The system successfully detects the thumbs-up and next task is to detect account.
        :return:
        """
