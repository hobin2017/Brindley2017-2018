...
"""
Payment System
Compared with the version 1.1.0, one main difference is that the Weigher3 class is used in Klas;
author: hobin;
...
class PaymentSystem_klas(QObject):
    ...
    def weigher1_work1_klas(self):
        ...
        self.timer1.start(120000) # unit: millisecond, 24 hrs = 24*60*60*1000, 2 mins = 120000
