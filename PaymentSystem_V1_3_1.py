...
from ML_Model import Detection1, Detection2_1
...
class PaymentSystem(QMainWindow):
    ...
    def work14(self, wechatpay_entrust):
        ...
        if wechatpay_entrust == 0:
            self.main_widget.mainlayout.rightlayout.secondlayout_main.setCurrentWidget(self.main_widget.mainlayout.rightlayout.secondlayout_2ndWidget)
