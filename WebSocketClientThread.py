...
class MyThread8_1(QObject):
    ...
    def __init__(self, socketUrl='http://sys.commaai.cn', storeName='development center for testing', storeId=2,
                 screenId=1):
        super(MyThread8_1, self).__init__()
        self.socketUrl = socketUrl
        self.socketUrl_port = 60000
        self.storeName = storeName
        self.storeId = storeId
        self.screenId = screenId
        self.msg = '{"store_id":"%s", "remark":"%s", "screen_id": "%s"}' % (storeId, storeName, screenId)
