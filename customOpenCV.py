...
#				self.faceCascade.load(cascPath)
	...
	def queryFrame(self):
		...
		if self.showHandGif == True:
			g = cv2.resize(self.gif[self.gifindex],(100,100))
			img = drawFrame[self.handY-50:self.handY+50,self.handX-50:self.handX+50]
			img = cv2.addWeighted(img,1,g,0.8,0)
			drawFrame[self.handY-50:self.handY+50,self.handX-50:self.handX+50] = img
