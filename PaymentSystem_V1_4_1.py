...
from sqlThread import MyThread3_1
from AccountThread import MyThread4_4_1
from QRcodeThread import MyThread5_1
...
class PaymentSystem(QMainWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.thread4 = MyThread3_1(parent=self, **self.myconfig.data['db'])
        ...
        self.thread6 = MyThread5_1(parent=self, **self.myconfig.data['order'])
        ...
        #
        del self.myconfig  # It is deleted since it is useless anymore.
    ...
    def error03(self):
        """
        Error might happens in the Image_upload thread
        :return: 
        """
        self.thread10.start()
