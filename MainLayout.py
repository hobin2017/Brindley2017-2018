...
from CameraLayout import CameraWidget
...
class MainLayout(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.mainlayout.addLayout(self.mainlayout.leftlayout, 5)# the second parameter is stretch factor
        ...
        self.mainlayout.rightlayout.secondlayout = CameraWidget()
