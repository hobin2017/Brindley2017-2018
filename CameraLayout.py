...
from PyQt5.QtGui import QImage, QPixmap, QMovie, QPalette, QColor
...
class CameraWidget3(QLabel):
    """
    This QWidget will display a circle to indicate that we detects your thumbs-up.
    """
    def __init__(self, parent=None):
