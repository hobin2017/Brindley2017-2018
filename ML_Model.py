...
class Detection2_simulation(QThread):
    """
    Sometimes you need to refresh the image. For instance, Klas_V1_1_2 requires the user image.
    In Klas_V1_1_2, account thread requires the image not None since it will use indexing operation;
    """
    detected = pyqtSignal()
    detected_gesture_info = pyqtSignal(object, object)  # frame, gesture location information
    upload_image = pyqtSignal(object, object)
