...
class PaymentSystem_klas(QObject):
    ...
    def getting_ip_address(self):
        ...
        host_info = QHostInfo()
        my_destop_name = host_info.localHostName()  # The result is 'DESKTOP-Q429194'.
        ip_addresses_object = QHostInfo.fromName(my_destop_name)  # <class 'PyQt5.QtNetwork.QHostInfo'>
        ip_address_list = ip_addresses_object.addresses()  # returns the list of IP addresses associated with hostName()
        # print(QAbstractSocket.IPv4Protocol)  # the value is 0.
        # print(QAbstractSocket.IPv6Protocol)  # the value is 1.
        for address in ip_address_list:
            # print(type(address))  # <class 'PyQt5.QtNetwork.QHostAddress'>
            if address.protocol() == QAbstractSocket.IPv4Protocol:
                self.current_ip_address = address.toString()
                break
    ...
    def database_update_work26(self):
        """
        to query the database every 5 minutes.
        :param sku_list:
        :return:
        """
    ...
    def database_update_work28(self, dict_key, image_binary):
        """
        it is executed by the skuDownloadThread class
        :param dict_key: str
    ...
    def error10(self):
        """
        error09 is about the item quality since we sale food.
        :return:
        """
        pass
